<template>
    ...
    <hr />
    <h4 class="title is-4">Buttons</h4>
        ...
        <div class="tile is-vertical is-4">
            <div class="tile">
                <div class="tile is-parent is-vertical">
                    ...
                    <p class="title is-6">Outlined (Hover to see it on action)</p>
        ...
        <div class="tile is-vertical is-4">
            <div class="tile">
                <div class="tile is-parent is-vertical">
                    ...
                    <p class="title is-6">Inverted (Hover to see it on action)</p>
        ...
        <div class="tile is-vertical is-4">
            <div class="tile">
                <div class="tile is-parent is-vertical">
                    ...
                    <p class="title is-6">Invert Outlined (Hover to see it on action)</p>
    ...
    <div class="tile is-ancestor is-12">
        ...
        <div class="tile is-vertical is-4">
            <div class="tile">
                <div class="tile is-parent is-vertical">
                    <article class="tile is-child notification">
                    <p class="title is-6">With Font Awesome Icons</p>
                        <p class="buttons">
                            <a class="button">
    ...
    <div class="tile is-ancestor is-12">
        <div class="tile is-vertical is-4">
            <div class="tile">
                <div class="tile is-parent is-vertical">
                    <article class="tile is-child notification">
                    <p class="title is-6">Button addons</p>
      ...
      <span>Right</span>
        ...
        <div class="tile is-vertical is-4">
            <div class="tile">
                <div class="tile is-parent is-vertical">
                    <article class="tile is-child notification">
                    <p class="title is-6">Other Buttons</p>
